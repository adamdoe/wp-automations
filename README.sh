...
echo "================================================================="
echo "Beginning WordPress Install..."
echo "================================================================="
...
wp core config --dbname=$dbname --dbuser=root --extra-php <<PHP
...
wp db create
wp core install --url="http://localhost/$currentdirectory" --title="$sitename" --admin_user="$wpuser" --admin_password="$password" --admin_email="your@emailhere.com"
